...
class Dialog(QDialog):
    ...
    def createSidebar(self):
        # self.sidebarGroupBox = QGroupBox("Sidebar group")
        # layout = QVBoxLayout()

        self.sidebar = QListWidget()
        self.sidebar.show()
        ls = ['test0', 'test1', 'test2', 'test3', 'test4']
        self.sidebar.addItems(ls)
        self.sidebar.resize(100, 480)
        self.sidebar.itemClicked.connect(self.onItemClickOnList)
        # self.sidebarGroupBox.addWidget(self.sidebar)
